package com.wishhard.h24.settings;
...
public class CustomSwitchPref extends SwitchPreferenceCompat {
    ...
    private void customThumbAndTracker(SwitchCompat v) {
        int mediumYellow = ContextCompat.getColor(mContext, R.color.medium_yellow);
        int mediumGrey = ContextCompat.getColor(mContext, R.color.medium_grey);
        int alphaMediumYellow = Color.argb(127, Color.red(mediumYellow), Color.green(mediumYellow), Color.blue(mediumYellow));
